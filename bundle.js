...
/***/ function(module, exports, __webpack_require__) {
	...
	var TimeLog = __webpack_require__(166);
	...
	var daysData = [{
	    ...
	    punches: [{ id: "asdfdf", in: "4:47", out: "8:30" }, { id: "afasdf", in: "8:47", out: "9:30" }, { id: "asdfaf", in: "10:00", out: "10:40" }, { id: "asdfas", in: "10:47", out: null }]
	}, {
	    ...
	    punches: [{ id: "asdfd", in: "8:30", out: "12:30" }, { id: "sdfas", in: "1:00", out: "5:30" }]
	}];
	...
	ReactDOM.render(React.createElement(
	    ...
	    React.createElement(
	        'div',
	        { 'class': 'days' },
	        React.createElement(TimeLog, { days: daysData })
	    )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _rowDay = __webpack_require__(167);

	var _rowDay2 = _interopRequireDefault(_rowDay);
	...
	var TimeLog = function (_Component) {
	    _inherits(TimeLog, _Component);

	    function TimeLog() {
	        _classCallCheck(this, TimeLog);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(TimeLog).apply(this, arguments));
	    }
	    ...
	    _createClass(TimeLog, [{
	        ...
	        key: 'getDayRow',
	        value: function getDayRow(day) {
	            return _react2.default.createElement(_rowDay2.default, { key: day.date, className: _index2.default.day, day: day });
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _rowTime = __webpack_require__(168);

	var _rowTime2 = _interopRequireDefault(_rowTime);
	...
	var RowDay = _react2.default.createClass({
	  displayName: 'RowDay',
	  getInitialState: function getInitialState() {
	    return { isCollapsed: this.props.collapsed === 'true' };
	  },
	  ...
	  getDayDetail: function getDayDetail() {
	  ...
	  getTimeDetail: function getTimeDetail() {
	    if (this.state.isCollapsed == true) return _react2.default.createElement('td', { className: _index2.default.punches, onClick: this.toggleCollapsed });

	    return _react2.default.createElement(
	      'td',
	      { className: _index2.default.punches },
	      this.props.day.punches.map(this.getRowTime)
	    );
	  },
	  getRowTime: function getRowTime(punch) {
	    return _react2.default.createElement(_rowTime2.default, { key: punch.id, punch: punch });
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RowTime = function (_Component) {
	    _inherits(RowTime, _Component);

	    function RowTime() {
	        _classCallCheck(this, RowTime);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(RowTime).apply(this, arguments));
	    }

	    _createClass(RowTime, [{
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                { className: _index2.default.punchRow },
	                _react2.default.createElement(
	                    'div',
	                    { className: _index2.default.punchIn },
	                    this.props.punch.in
	                ),
	                _react2.default.createElement(
	                    'div',
	                    { className: _index2.default.punchOut },
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js?modules!./../../node_modules/autoprefixer-loader/index.js!./index.css", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js?modules!./../../node_modules/autoprefixer-loader/index.js!./index.css");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "._2SW1woZboYip-bsM3r09kx div {\r\n    font-family: Arial, Helvetica, sans-serif;\r\n    text-align: right;\r\n    padding: 5px 20px;\r\n}\r\n\r\n/*.punchIn {\r\n}*/\r\n\r\n._3cPmdyRR2Y3O-Jg074JI0n {\r\n    /* Permalink - use to edit and share this gradient: http://colorzilla.com/gradient-editor/#ffffff+0,c6c6c6+51&0+0,0.68+35 */ /* FF3.6-15 */\r\n    background: -webkit-linear-gradient(left,  rgba(255,255,255,0) 0%,rgba(216,216,216,0.68) 35%,rgba(198,198,198,0.68) 51%); /* Chrome10-25,Safari5.1-6 */\r\n    background: linear-gradient(to right,  rgba(255,255,255,0) 0%,rgba(216,216,216,0.68) 35%,rgba(198,198,198,0.68) 51%); /* W3C, IE10+, FF16+, Chrome26+, Opera12+, Safari7+ */\r\n    filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#00ffffff', endColorstr='#adc6c6c6',GradientType=1 ); /* IE6-9 */\r\n}", ""]);

	// exports
	exports.locals = {
		"punchRow": "_2SW1woZboYip-bsM3r09kx",
		"punchOut": "_3cPmdyRR2Y3O-Jg074JI0n"
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "div.usprBPyHohNzKaX7a1bQT {\r\n    text-align: center;\r\n    padding: 0 15px;\r\n}\r\n\r\n", ""]);

	// exports
	exports.locals = {
		"day": "usprBPyHohNzKaX7a1bQT"
	};
